...
///////////////////////////////////////////////////////////////////////////////////////
	...
	@Override public void handle(ActionEvent e){
		try {
			PescaEsercizi paginadomande=new PescaEsercizi("/home/alessio/Scrivania/java/domande");
    ...
    if(c>-1) {
        if(matrice[h][1]==0) {                  //se l'ultima azione è stata una cancelazione allora reinserisco nell'albero il numero cancellato
        	rbt.treeInsert(matrice[h][0]);
        	this.ridisegna();
        	System.out.println(matrice[h][0]);
        }else {									//se è un inserimento allora cancello il numero inserito
        	rbt.treeDelete(matrice[h][0]);		
        	this.ridisegna();
        	System.out.println(matrice[h][0]);
        }
        h--;									//con h-- "punto" all'azione precedente nel caso voglia cambiare anche quella
    }
    }
    
    public void btnForward_Clicked(){
    }
 //Ho separato il codice per ridisegnare l'albero dall'insert de dal delete per poterlo utilizzare anche il altre funzioni
    ...
    public void btnInsert_Clicked(){
        ...
        //qui registro l'azione inserimento nella matrice
        	...
        	//test System.out.println(matrice[c][0]);
    }
